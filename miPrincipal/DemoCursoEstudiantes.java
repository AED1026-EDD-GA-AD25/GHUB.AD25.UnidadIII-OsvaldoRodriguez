...
public class DemoCursoEstudiantes {
    public static void inicio() {
        ...
        Curso curso1 = new Curso("Estructura de Datos",new LinkedList<Estudiante>());
        ////Crear un curso con una lista de estudiantes utilizando un ArrayList
        Curso curso2 = new Curso("Programacion Orienta a Objetos",new ArrayList<Estudiante>());
        ...
        //agregar estudiantes al curso2
        curso2.agregarEstudiante(new Estudiante("Fernando Montero","25240002",8.9));
        curso2.agregarEstudiante(new Estudiante("Rosa Lozano","20250003",0.0));
        ...
        System.out.println("Integrantes del curso "+curso1.getNombreCurso());
        curso1.listarEstudiantes();
        Estudiante est = curso1.buscarEstudiante("20250002");
        System.out.println("Nombre de estudiante buscado: "+est.getNombre());
